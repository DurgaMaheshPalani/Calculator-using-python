...
print("6 : Cosine in radians")
print("7 : Tan in radians")
print("8 : Cosecant in radians")   
print("9 : Secant in radians")
print("10: Cot in radians")
print("11: pi")
print("12: Sine in degrees")
print("13: Cosine in degrees")
print("14: Tan in degrees")
print("15: Cosecant in degrees")
print("16: Secant in degrees")
print("17: Cot in degrees")
print('*'*20)
print("LOGARITHMIC")
print('*'*20)
print("18: Natural log")
print("19: Base 10 log")
print("20: Log base 'x'")
print("21: Square root")
print("22: Power of")
print('*'*60)
choice = ""
while True:
